...
echo "got get a drink -- npm install will run a long time"
npm install -y
cd
...
sudo cp -r "$HOME"/m2ag-labs/installer/extras/gateway/m2ag-gateway-proxy /etc/nginx/sites-available/m2ag-gateway-proxy
